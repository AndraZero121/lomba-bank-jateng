...
import { FiArrowLeft, FiUser, FiBriefcase, FiCreditCard, FiDollarSign, FiCalendar, FiHome, FiTrendingUp, FiCheckSquare, FiFileText } from 'react-icons/fi';
...
export default function EditKaryawan() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await setBaseUrl.put(`/karyawan/${id}`, form);
      Swal.fire({
        icon: 'success',
        title: 'Berhasil',
      ...
      Swal.fire({
        icon: 'error',
        title: 'Gagal',
        text: error.response?.data?.message || 'Gagal memperbarui karyawan',
        confirmButtonText: 'OK'
      });
    }
  };
  ...
  return (
    <div className="edit-karyawan-page bg-light">
            ...
            <form onSubmit={handleSubmit} className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <div className="mb-3">
                  ...
                  <select className="form-select" name="status_kepegawaian" value={form.status_kepegawaian || 'Tetap'} onChange={handleChange}>
