...
import { Card, ProgressBar, Table, Navbar, Nav, Dropdown } from 'react-bootstrap';
import {
...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard-container d-flex flex-column min-vh-100">
      {/* Enhanced Navbar */}
      <Navbar bg="white" expand="lg" className="custom-navbar shadow-sm border-bottom">
        <div className="container">
          <Navbar.Brand as={Link} to="/dashboard" className="brand-container d-flex align-items-center">
            <div className="brand-logo me-3">
              <img src="bank_jateng.png" alt="Logo" width="50" height="40" className="logo-img" />
            </div>
            <div className="brand-text">
              <span className="brand-name fw-bold text-dark">Bank Jateng Syariah</span>
              <small className="brand-subtitle d-block text-muted">Payroll Management System</small>
            </div>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto">
              <Nav.Link as={Link} to="/dashboard" className="nav-item-custom fw-semibold mx-2">
                Dashboard
              </Nav.Link>
              <Nav.Link as={Link} to="/karyawan" className="nav-item-custom fw-semibold mx-2">
                Karyawan
              </Nav.Link>
              <Nav.Link as={Link} to="/departemen" className="nav-item-custom fw-semibold mx-2">
                Departemen
              </Nav.Link>
              <Nav.Link as={Link} to="/jabatan" className="nav-item-custom fw-semibold mx-2">
                Jabatan
              </Nav.Link>
              <Nav.Link as={Link} to="/laporan" className="nav-item-custom fw-semibold mx-2">
                Laporan
              </Nav.Link>
              <Nav.Link as={Link} to="/payroll" className="nav-item-custom fw-semibold mx-2">
                Payroll
              </Nav.Link>
            </Nav>
            
            <Nav className="ms-auto align-items-center">
              {/* Hanya user dropdown dan logout */}
              <Dropdown className="ms-3" align="end">
                <Dropdown.Toggle 
                  variant="light" 
                  id="dropdown-user"
                  className="user-dropdown-toggle bg-transparent border-0 d-flex align-items-center p-2"
                >
                  <div className="user-info d-flex align-items-center">
                    ...
                    />
                    <div className="user-details text-start me-2 d-none d-md-block">
                      <span className="user-name fw-semibold text-dark d-block">{user.name}</span>
                      <small className="user-role text-muted">{user.roles}</small>
                    </div>
                ...
                <Dropdown.Menu className="user-dropdown-menu shadow-lg border-0">
                  <div className="user-dropdown-header px-3 py-3 border-bottom bg-light">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <span className="badge bg-primary">{user.roles}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <Dropdown.Divider />
                  {/* Tambahkan route ke datakaryawan */}
                  <Dropdown.Item
                    as={Link}
                    to="/datakaryawan"
                    className="dropdown-item-custom d-flex align-items-center py-2"
                  >
                    <FiUsers className="me-2" size={16} />
                    Data Karyawan Saya
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item 
                    onClick={handleLogout}
                    className="dropdown-item-custom logout-item d-flex align-items-center py-2 text-danger"
                  >
